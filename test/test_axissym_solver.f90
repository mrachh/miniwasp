...
!
      ...
      fname = '../geometries/boundary_axissym_radii.dat'
      open(unit=33,file=trim(fname))
      do i=1,nskip
        read(33,*) tmp1,tmp2
      enddo
      do i=1,nz
        read(33,*) rzbdry(1,i),rzbdry(2,i)
      enddo
      close(33)
      ...
      open(unit=33,file='srcinfo.dat')
      open(unit=34,file='srccoefs.dat')
      do i=1,npts
        write(33,'(12(2x,e11.5))') srcvals(1:12,i)
        write(34,'(9(2x,e11.5))') srccoefs(1:9,i)
      enddo
      close(33)
      close(34)
...
!
      ...
      do i=1,nin
        write(37,*) dpot(i),xyz_in(1,i),xyz_in(2,i),xyz_in(3,i)
      enddo
      close(37)
...
!      goto 1121
 ...
 1121 continue 
      ...
      open(unit=33,file='targ_out.dat')
      ndtarg = 3
      ii = 0
      do iz=1,nz
        z0 = rzbdry(2,iz)
      ...
      do i=1,ntarg
        write(38,*) dpot(i),targs(1,i),targs(2,i),targs(3,i)
      enddo
      close(38)
...
!          ra = ra + abs(potex(i))**2
       ...
       if(ibc.eq.1) then
         write(fname,'(a,i1,a,i1,a)') 'nc-data/axissym_pot_norder', &
         ...
         enddo
         close(33)
         write(fname,'(a,i1,a,i1,a)') 'nc-data/axissym_sigma_norder', &
            norder,'_ippw',ippw,'.dat'
         open(unit=33,file=trim(fname))
         do i=1,npts
