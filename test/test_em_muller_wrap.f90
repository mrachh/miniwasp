      ...
      character *300 fname1,fname2,fname3,fsol,ftarg
      ...
      contrast_matrix(1,1)=1.0d0  
      contrast_matrix(2,1)=1.0d0  
      contrast_matrix(3,1)=1.452d0  
      contrast_matrix(4,1)=1.0d0

      contrast_matrix(1,2)=1.0d0  
      contrast_matrix(2,2)=1.0d0  
      contrast_matrix(3,2)=1.348d0  
      contrast_matrix(4,2)=1.0d0

      contrast_matrix(1,3)=1.0d0  
      contrast_matrix(2,3)=1.0d0  
      contrast_matrix(3,3)=1.363d0  
...
!      string1 = '../geometries/simplest_cube_quadratic_v4_o08_r02.go3?'
      string1 = trim(fname1)//trim(fname2)//trim(fname3)
